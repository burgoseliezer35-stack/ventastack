...
export function AccionesFactura({
  ...
  cfdiUrl: cfdiUrlInicial, clienteEmail, clienteWhatsapp, clienteNombre,
}: {
  solicitudId: string;
  companyId: string;
  folio: string;
    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="rounded-xl border border-linea bg-white p-5">
        ...
        {cfdiUrl ? (
          ...
          <label className={`flex flex-col items-center gap-2 rounded-xl border-2 border-dashed p-4 cursor-pointer transition ${
            ...
            <input type="file" accept="application/pdf" className="hidden" onChange={subirCfdi} disabled={subiendoCfdi} />
          </label>
        )}
      </div>
